...
![](All Code + Diagram (Pictures)/FSM/FSMvhd1.png)
![](All Code + Diagram (Pictures)/FSM/FSMvwf.png)

Latches (VHDL and waveform)
![](All Code + Diagram (Pictures)/Latch/LatchVHD.png)
![](All Code + Diagram (Pictures)/Latch/Latch1VWF.png)

ALU diagrams and waveforms
![](All Code + Diagram (Pictures)/ALU/ALU1.png)
![](All Code + Diagram (Pictures)/ALU/ALU2.png)

Top-level block and waveform
![](All Code + Diagram (Pictures)/BDFdiagram.png)
![](All Code + Diagram (Pictures)/VWF_final.png)
